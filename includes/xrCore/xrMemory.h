#pragma once
#include "xrMemoryLeakDetection.h"
...
public:
	...
	xrMemLeakTracker MemLeakTracker;
#endif
...
public:
	...
	void*				mem_alloc_for_arrays(size_t size, const char* typeName);
	void*				mem_alloc(size_t size);
	void*				mem_alloc(size_t size, size_t aligment);

	void*				mem_realloc(void* p, size_t size);
	void				mem_free_for_arrays(void* p, const char* typeName);
	...
	void				GetMemoryDescription(void* InPtr, string2048& OutInfo);
