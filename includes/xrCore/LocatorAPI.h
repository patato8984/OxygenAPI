...
public:
    ...
    using archives_vec = xvector<archive>;
...
private:
	...
	using FFVec = xvector<_finddata64i32_t>;
	FFVec						rec_files;
...
public:
	...
	xvector<char*>*			file_list_open		(const char* initial, const char* folder,	u32 flags=FS_ListFiles);
	xvector<char*>*			file_list_open		(const char* path,					u32 flags=FS_ListFiles);
	void						file_list_close		(xvector<char*>* &lst);
    ...
    bool                        getFileName         (const char* path, string512& outFilename);
};
