...
public:
	...
	IC	SelfRef	BuildOrthoOffCenterLH(T left, T right, T top, T buttom, T tFar, T tNear)
	{
		_11 = T(-2) / (left - right);	_12 = 0;					_13 = 0;					  _14 = 0;
		_21 = 0;						_22 = T(-2)/(top - buttom);	_23 = 0;					  _24 = 0;
		_31 = 0;						_32 = 0;					_33 = T(-1) / (tFar - tNear); _34 = 0;
		
		_41 = -((right + left) / (right - left));						
		_42 = (top + buttom) / (top - buttom);
		_43 = tFar / (tFar - tNear);
		_44 = 1;
		return *this;
	}
