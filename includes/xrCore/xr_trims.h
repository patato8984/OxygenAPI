...
XRCORE_API xstring& 		_Trim					( xstring& src );
XRCORE_API xstring& 		_TrimLeft				( xstring& src );
XRCORE_API xstring&		_TrimRight				( xstring& src );
XRCORE_API xstring&   	_ChangeSymbol			( xstring& name, char src, char dest );
XRCORE_API const char*		 	_CopyVal 				( const char* src, xstring& dst, char separator=',' );
XRCORE_API const char*			_GetItem				( const char* src, int, xstring& p, char separator=',', const char* ="", bool trim=true );
XRCORE_API xstring		_ListToSequence			( const SStringVec& lst );
