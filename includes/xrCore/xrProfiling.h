...
public:
	...
	const xr_map<const char*, StartAndEnd>& GetProfilerResults() const { return *frontBacket; }
private:
	...
	xr_map<const char*, StartAndEnd>* frontBacket = nullptr;
	xr_map<const char*, StartAndEnd>* backBacket = nullptr;

	xr_map<const char*, StartAndEnd> profilingBacket1;
	xr_map<const char*, StartAndEnd> profilingBacket2;
